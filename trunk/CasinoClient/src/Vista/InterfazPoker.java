...
public class InterfazPoker extends JPanel {
    ...
    private JLabel lblPuntos = new JLabel("Puntos Acumulados");
    private JLabel lblCantidadAApostar = new JLabel("Cantidad a Apostar:");
    private JLabel lblTotalEnLa = new JLabel("Total en la mesa:");
    ...
    public JLabel getLblCantidadAApostar() {
        return lblCantidadAApostar;
    }

    public void setLblCantidadAApostar(JLabel lblCantidadAApostar) {
        this.lblCantidadAApostar = lblCantidadAApostar;
    }
    ...
    public JLabel getLblTotalEnLa() {
        return lblTotalEnLa;
    }

    public void setLblTotalEnLa(JLabel lblTotalEnLa) {
        this.lblTotalEnLa = lblTotalEnLa;
    }
    ...
    public JButton getBtnResto() {
        return btnResto;
    }

    public JButton getBtnApuesto() {
        return btnApuesto;
    }
